...
It combines industriesâ€™ most advanced stepper motor driver based on the 256-usteps built-in indexer and two fully integrated 36V, 3.0AMAX H-Bridges plus non-dissipative Integrated Current Sensing (ICS).
