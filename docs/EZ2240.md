...
It combines industries’  most advanced stepper motor driver based on the 256-usteps built-in indexer and two fully integrated 36V, 3.0AMAX H-Bridges plus non-dissipative Integrated Current Sensing (ICS).

## **Main Features**

Voltage range 4.5… 36V DC 
Low Rdson (HS+LS): 230 m typical (TA=25C) 
...
Jerk-free combination of StealthChop and 
SpreadCycle 
